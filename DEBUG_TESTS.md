...
**Creation Time:** 2025-08-19T09:37:28.455Z
**Pacific Time:** Tuesday, August 19, 2025 at 02:37:28 AM PDT
...
## Failed Test 1: lib/additional-edge-cases.test.js

### Output:
```
FAIL lib/additional-edge-cases.test.js (7.012 s)
  Additional Edge Cases
    stripProtocol
      ✕ should return input when not string and log error (40 ms)
    parseUrlParts
      ✕ should return null for malformed url with protocol only (26 ms)
...
Snapshots:   0 total
Time:        7.213 s
Ran all test suites matching /lib\/additional-edge-cases.test.js/i.
...
## Failed Test 2: lib/system/env/env.test.js
...
Error: Environment access error
    ...
    at qerrors (/home/runner/workspace/lib/system/env/requireEnvVars.js:114:5)
...
## Failed Test 3: lib/system/realtime/realtime.test.js

### Output:
```
FAIL lib/system/realtime/realtime.test.js (7.663 s)
  Real-time Communication Utilities
    createBroadcastRegistry
      ✕ should create registry with specified functions (31 ms)
      ✕ should handle invalid configuration gracefully (5 ms)
      ✓ should allow setting and getting broadcast functions (6 ms)
      ✕ should reject non-function values (4 ms)
      ✓ should allow setting functions to null (2 ms)
      ✕ should track function readiness correctly (2 ms)
      ✕ should clear all functions (2 ms)
      ✕ should skip invalid function names (2 ms)
    ...
    createSocketBroadcastRegistry
      ...
      ✕ should execute assigned functions correctly (1 ms)
    ...
    validateBroadcastData
      ✕ should validate simple valid data (1 ms)
      ...
      ✕ should reject functions by default (1 ms)
    ...
    Integration Scenarios
      ...
      ✕ should support testing with mock functions (4 ms)
...
Snapshots:   0 total
Time:        7.927 s
Ran all test suites matching /lib\/system\/realtime\/realtime.test.js/i.
...
## Failed Test 4: lib/system/shutdown/shutdown-utils.test.js
...
## Failed Test 5: lib/system/worker-pool/worker-pool.test.js
...
## Failed Test 6: lib/utilities/datetime/datetime-enhanced.test.js
...
## Failed Test 7: lib/utilities/datetime/datetime.test.js
...
## Failed Test 8: lib/utilities/file/file-utils.test.js
...
## Failed Test 9: lib/utilities/id-generation/id-generation.test.js
...
## Failed Test 10: lib/utilities/string/string-utils.test.js
...
## Failed Test 11: lib/utilities/url/url.test.js
...
## Failed Test 12: lib/validation/advanced-validation.test.js

### Output:
```
FAIL lib/validation/advanced-validation.test.js (8.424 s)
  Advanced Validation Utilities
    validateEmail
      ✓ should validate correct email formats (233 ms)
      ✓ should reject invalid email formats (34 ms)
      ✓ should handle empty or invalid input types (33 ms)
      ✓ should sanitize input before validation (22 ms)
    validateRequired
      ✓ should validate non-empty required fields (72 ms)
      ✓ should reject empty or whitespace-only fields (29 ms)
      ✓ should validate minimum length requirements (61 ms)
      ✓ should handle invalid input types (80 ms)
      ✕ should use singular/plural correctly in error messages (9 ms)
    validateMaxLength
    ...
    validateSelection
      ...
      ✕ should use lowercase field names in error messages (4 ms)
    combineValidations
      ✕ should return empty string when all validators pass (1 ms)
      ✕ should return first error encountered
      ✕ should handle validators that throw exceptions (5 ms)
    ...
    validateObjectId
      ✕ should validate correct MongoDB ObjectId formats (1 ms)
      ✕ should sanitize input before validation
      ✕ should throw error for invalid input types (112 ms)
      ✕ should throw error for empty input (2 ms)
      ✕ should throw error for invalid ObjectId formats (2 ms)
      ✕ should use custom field names in error messages (3 ms)
...
Test Suites: 1 failed, 1 total
Tests:       21 failed, 8 passed, 29 total
Snapshots:   0 total
Time:        8.689 s
Ran all test suites matching /lib\/validation\/advanced-validation.test.js/i.
...
## Failed Test 13: lib/validation/github-validation.test.js

### Output:
```
FAIL lib/validation/github-validation.test.js (8.695 s)
  GitHub Validation Utilities
    validateGitHubUrl
      ✓ should validate correct GitHub repository URLs (206 ms)
      ✓ should reject empty or invalid URLs (48 ms)
      ✓ should reject non-GitHub URLs (150 ms)
      ✓ should reject HTTP URLs (require HTTPS) (17 ms)
      ✓ should reject URLs with additional paths (218 ms)
      ✓ should handle malformed input safely (140 ms)
    extractGitHubInfo
      ✕ should extract owner and repository from valid URLs
      ✕ should handle URLs with special characters in names (1 ms)
    ...
    validateGitHubRepo
      ...
      ✕ should apply string sanitization (1 ms)
      ✕ should throw error for invalid input types (61 ms)
      ✕ should throw error for empty or invalid formats (37 ms)
    validateGitHubUrlDetailed
      ...
      ✕ should categorize protocol errors (2 ms)
      ✕ should categorize domain errors (1 ms)
      ✕ should categorize path errors
      ✕ should categorize invalid name errors
      ✕ should include original URL in all results (1 ms)
...
Test Suites: 1 failed, 1 total
Tests:       16 failed, 6 passed, 22 total
Snapshots:   0 total
Time:        8.964 s
Ran all test suites matching /lib\/validation\/github-validation.test.js/i.
...
## Failed Test 14: lib/validation/validation.test.js
...
FAIL lib/validation/validation.test.js
  Validation Utilities
    requireFields
      ✓ should return true when all required fields are present (10 ms)
      ✕ should return false and send error for missing fields (14 ms)
      ✕ should return false for multiple missing fields (5 ms)
      ✕ should treat falsy values as missing (37 ms)
      ...
      ✕ should handle null object gracefully (10 ms)
      ✓ should accept truthy values (2 ms)
      ✕ should handle invalid requiredFields parameter (4 ms)
      ✕ should handle non-array requiredFields parameter (4 ms)
...
Snapshots:   0 total
Time:        5.05 s
Ran all test suites matching /lib\/validation\/validation.test.js/i.
...
## Failed Test 15: tests/integration/error-handling.test.js

### Output:
```
FAIL tests/integration/error-handling.test.js (6.107 s)
  Error Handling Integration Tests
    Cascading Error Scenarios
      ✕ should handle multiple module failures gracefully (16 ms)
      ✕ should handle error propagation in API workflow (3 ms)
    View Rendering Error Recovery
      ✕ should handle template rendering failures across multiple views
      ✕ should handle route registration with missing global app (12 ms)
    Authentication Error Scenarios
      ✓ should handle passport strategy detection with broken global state (17 ms)
      ✓ should handle authentication with various request object states (31 ms)
    URL Processing Error Recovery
      ✓ should handle malformed URLs throughout processing pipeline (26 ms)
      ✓ should handle URL processing with partial failures (56 ms)
