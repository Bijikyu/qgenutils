...
function generateExecutionId() {
  console.log('generateExecutionId creating new execution ID');
  ...
  try {
    ...
    try {
      ...
      console.warn('generateExecutionId: nanoid failed, using fallback method');
    ...
    console.log(`generateExecutionId created ID: ${executionId}`);
    ...
    console.error('generateExecutionId encountered unexpected error:', error.message);
    ...
    console.log(`generateExecutionId using fallback ID: ${fallbackId}`);
