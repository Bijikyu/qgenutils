...
function buildCleanHeaders(headers, method, body) {
    ...
    try {
        ...
        // We check Object.keys(body).length > 0 to distinguish between empty objects and null/undefined
        ...
        if (method.toLowerCase() !== 'get' && body && Object.keys(body).length > 0) {
            cleanHeaders['content-length'] = calculateContentLength(body); // Recalculate for accuracy
        }
