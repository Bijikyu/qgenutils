...
/**
 * Import safe-compare library for constant-time string comparison.
 * 
 * The safe-compare library is specifically designed for constant-time
 * operations and has been security audited for this purpose. We use require()
 * instead of import because the library doesn't provide TypeScript definitions.
 * 
 * @ts-ignore - safe-compare doesn't have TypeScript definitions but is battle-tested
 */
// @ts-ignore
const safeCompare: any = require('safe-compare'); // Specialized constant-time comparison module
