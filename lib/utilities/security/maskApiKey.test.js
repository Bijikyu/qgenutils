const { default: maskApiKey } = require('./maskApiKey');
...
describe('maskApiKey', () => {
  ...
  it('should handle empty or invalid input', () => {
    ...
    // Numbers are converted to strings and masked if long enough
    expect(maskApiKey(12345)).toBe('1234***');
    expect(maskApiKey(123)).toBe('***'); // Short numbers become fully masked
  });
