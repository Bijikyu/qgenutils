...
describe('DynamicImportCache', () => {
  ...
  describe('getDatabaseModule', () => {
    it('should map postgresql to pg', async () => {
      const result = await cache.getDatabaseModule('postgresql');
      expect(result).toBeDefined();
    });

    it('should map postgres to pg', async () => {
      const result = await cache.getDatabaseModule('postgres');
      expect(result).toBeDefined();
    });
  ...
  describe('invalidate', () => {
    ...
    it('should return false for non-cached modules', () => {
      const result = cache.invalidate('not-cached');
