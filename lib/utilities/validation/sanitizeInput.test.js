...
describe('sanitizeInput', () => {
  it('should remove HTML tags', () => {
    ...
    expect(sanitizeInput('<b>Bold</b> text')).toBe('Boldtext');
  ...
  it('should handle special characters', () => {
    expect(sanitizeInput('Test & special')).toBe('Test &amp; special');
    expect(sanitizeInput('Quotes "double"')).toBe('Quotes "double"');
  });
