...
const zodValidationUtils = {
   ...
   */
  validateString: (input, fieldName: any): any => { // validate and trim string
   ...
   */
  validateApiKey: (apiKey, serviceName: any): any => { // validate API key
   ...
   */
  validateEmail: (email: any, fieldName: any = 'email'): any => { // validate email format
    const validated: any = zodValidationUtils.validateString(email, fieldName);
   ...
   */
  validateRequiredFields: (obj, requiredFields, context: any): any => { // validate required fields
   ...
   */
  validateChoice: (value, allowedValues, fieldName: any): any => { // validate value in allowed list
   ...
   */
  validateNumber: (value: any, fieldName: any, options: any = {}): any => { // validate number with options
...
export default zodValidationUtils;
