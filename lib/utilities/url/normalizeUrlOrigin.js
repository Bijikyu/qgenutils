...
function normalizeUrlOrigin(url) {
  console.log(`normalizeUrlOrigin processing URL: ${url}`);
  ...
  try {
    ...
    if (!isValidString(url)) {
      console.log('normalizeUrlOrigin: invalid input, returning null');
    ...
    if (trimmedUrl === '') {
      console.log('normalizeUrlOrigin: empty URL, returning null');
    ...
    try {
      ...
      console.log(`normalizeUrlOrigin: URL parsing failed: ${parseError.message}`);
    ...
    if (!protocol.match(/^https?:$/)) {
      console.log(`normalizeUrlOrigin: unsupported protocol: ${protocol}`);
    ...
    if (!hostname || hostname === '') {
      console.log('normalizeUrlOrigin: missing or empty hostname');
    ...
    console.log(`normalizeUrlOrigin: normalized to ${normalizedOrigin}`);
    ...
    console.error('normalizeUrlOrigin encountered unexpected error:', error.message);
