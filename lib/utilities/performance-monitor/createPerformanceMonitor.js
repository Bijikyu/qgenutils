...
const { createMetricsCollector, measureEventLoopLag } = require('./metricCollectionUtils'); // unified metric collection
...
function createPerformanceMonitor(options = {}) { // factory for performance monitor instance
  ...
  const metricsCollector = createMetricsCollector(); // unified metric collection
