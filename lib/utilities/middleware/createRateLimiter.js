...
const buildRateLimitKey = require('../security/buildRateLimitKey'); // rationale: keep existing key building for compatibility
...
function createRateLimiter(config = {}) {
  ...
  const finalWindowMs = windowMs || durationMs || 60000;
  const finalMax = max || points || 100;
