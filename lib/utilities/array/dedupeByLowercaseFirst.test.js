...
describe('dedupeByLowercaseFirst', () => {
  ...
  it('should throw TypeError for non-array input', () => {
    expect(() => dedupeByLowercaseFirst(null, x => x)).toThrow(TypeError);
    expect(() => dedupeByLowercaseFirst(undefined, x => x)).toThrow(TypeError);
    expect(() => dedupeByLowercaseFirst('string', x => x)).toThrow(TypeError);
    expect(() => dedupeByLowercaseFirst({}, x => x)).toThrow(TypeError);
  });

  it('should throw TypeError for non-function keyOf', () => {
    const items = [{ name: 'Alice' }];
    expect(() => dedupeByLowercaseFirst(items, null)).toThrow(TypeError);
    expect(() => dedupeByLowercaseFirst(items, 'name')).toThrow(TypeError);
    expect(() => dedupeByLowercaseFirst(items, undefined)).toThrow(TypeError);
  });
