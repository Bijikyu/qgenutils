 ...
 *
 * USAGE PATTERNS:
 * const fn: any = createDualVersionFunction((a, b) => a + b);
...
const createDualVersionFunction = (fn: any): any => {
  const dual = (...args: any): any => {
...
export default createDualVersionFunction;
