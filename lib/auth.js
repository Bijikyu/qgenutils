...
function hasGithubStrategy() {
  ...
  try {
    ...
    if (typeof passport === 'undefined') {
      console.log(`hasGithubStrategy is returning false`); // Log missing passport
    ...
    console.log(`hasGithubStrategy is returning ${!!hasStrategy}`); // Log strategy detection result
    return !!hasStrategy; // Convert to boolean (true if strategy exists)
  } catch (err) {
