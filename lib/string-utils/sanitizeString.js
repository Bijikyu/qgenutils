...
function sanitizeString(input) {
  console.log(`sanitizeString processing input type: ${typeof input}`);
  ...
  try {
    ...
    if (input === null || input === undefined) {
      console.log('sanitizeString: null/undefined input, returning empty string');
    ...
    try {
      ...
      console.error('sanitizeString: string conversion failed:', conversionError.message);
    ...
    // Handle empty string
    if (str === '') {
      console.log('sanitizeString: empty string input, returning empty string');
    ...
    console.log(`sanitizeString: processed ${originalLength} chars, removed ${charsRemoved} chars`);
    ...
    console.error('sanitizeString encountered unexpected error:', error.message);
